...
<p>
  <div class="buttons">
    ...
    <a href="https://github.com/Set-OutlookSignatures/Set-OutlookSignatures/blob/main/docs/CHANGELOG.md" class="button is-link is-normal is-hovered has-text-black  has-text-weight-bold">Read the changelog</a>
...
<p><a href="/quickstart" class="button is-link is-normal is-hovered has-text-black  has-text-weight-bold">Quickstart guide</a></p>
