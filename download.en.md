...
description: "Data Sovereign Email Signature"
permalink: "/download"
redirect_from:
  - "/download/"
...
<p>
Set-OutlookSignatures is the open-source standard for data sovereign email signatures.
</p>
...
<p>
  <div class="buttons">
    ...
    <a href="https://github.com/Set-OutlookSignatures/Set-OutlookSignatures/blob/main/docs/CHANGELOG.md" class="button is-info is-normal is-hovered  has-text-weight-bold">Read the changelog</a>
...
<p><a href="/quickstart" class="button is-info is-normal is-hovered  has-text-weight-bold">Quickstart guide</a></p>

<h2 id="benefactor-circle">The <a href="/benefactorcircle"><span style="font-weight: bold; color: var(--benefactor-circle-color);">Benefactor Circle add-on</span></a></h2>
