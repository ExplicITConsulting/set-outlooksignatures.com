            ...
            <div class="cell" style="display: flex; align-items: flex-start; gap: 0.5em;">
                ...
                <div>
                    ...
                    <ul style="list-style-type: none; margin-left: 0; padding-left: 0;">
                        ...
                        <li class="mb-2"><a href="#security-considerations">Security considerations</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="column is-one-third-desktop is-half-tablet is-full-mobile">
        <div class="box has-background-white-bis has-text-black" style="height: 100%; border-top: 4px solid Blue;">
            <div class="cell" style="display: flex; align-items: flex-start; gap: 0.5em;">
                <span>🎨</span>
                <div>
                    <p><b>Template Creation</b></p>
                    <ul style="list-style-type: none; margin-left: 0; padding-left: 0;">
                        <li class="mb-2"><a href="#signature-and-oof-template-file-format">Template file formats</a></li>
    ...
    <div class="column is-one-third-desktop is-half-tablet is-full-mobile">
        <div class="box has-background-white-bis has-text-black" style="height: 100%; border-top: 4px solid LimeGreen;">
            <div style="display: flex; align-items: flex-start; gap: 0.75em;">
                <span>🚀</span>
                <div>
                    <p><b>Logic & Deployment</b></p>
                    <ul style="list-style-type: none; margin-left: 0; padding-left: 0;">
                        <li class="mb-2"><a href="#template-tags-and-ini-files">Tags and INI files</a></li>
                        <li class="mb-2"><a href="#signature-and-oof-application-order">Application order</a></li>
...
<style>
  /* 1. HIGH-VISIBILITY SCROLLBARS (UNIVERSAL) */
  .scroll-sync-box::-webkit-scrollbar { height: 16px; display: block; }
  .scroll-sync-box::-webkit-scrollbar-track { background: #eee; }
  .scroll-sync-box::-webkit-scrollbar-thumb { background: #3273dc; border-radius: 10px; border: 3px solid #eee; }
  ...
  .top-bar { top: 0; border-bottom: 1px solid #dbdbdb; }
  .bottom-bar { bottom: 0; border-top: 1px solid #dbdbdb; }
  
  /* The container that actually holds the iframe */
...
<details class="p-0" style="border: 2px solid #dbdbdb; border-radius: 6px; position: relative;">
  ...
  <div id="top-scroll-wrapper" class="sticky-bar top-bar scroll-sync-box">
    <div id="top-scroll-spacer" style="height: 1px;"></div>
  </div>

  <div id="content-scroll-wrapper" class="scroll-sync-box">
    <div id="iframe-forcer" style="width: 100%;">
      <iframe
        id="my-iframe"
  ...
  <div id="bottom-mirror-wrapper" class="sticky-bar bottom-bar scroll-sync-box">
...
2.  Use the sample INI files shipped as a starting point.
3.  Put file names in square brackets.
4.  One tag per line below headers.
5.  Use parameters like [SignatureIniFile](/parameters#signatureinifile).
</div>
</div>
</div>
...
<div class="columns">
<div class="column">
<div class="box" style="height: 100%; border-left: 4px solid Blue;">

### Mailbox priority (highest → lowest)
1.  Mailbox of the currently logged-in user
2.  Mailboxes from the default Outlook profile
3.  Mailboxes from other Outlook profiles (alphabetical)
</div>
</div>
<div class="column">
<div class="box" style="height: 100%; border-left: 4px solid LimeGreen;">
