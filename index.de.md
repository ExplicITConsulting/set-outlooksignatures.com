...
<div class="columns is-multiline">
  <div class="column is-one-third-desktop is-half-tablet is-full-mobile">
    <div class="cell" style="display: flex; align-items: flex-start; gap: 0.5em;">
      <p><a href="/benefactorcircle#demo"><button class="button is-link is-normal is-hovered has-text-black" style="min-height: 4em; background-image: linear-gradient(to right, darkgoldenrod, goldenrod, darkgoldenrod, goldenrod, darkgoldenrod);">➔ Jetzt persönliche Demo vereinbaren</button></a></p>
    </div>
  </div>
...
<a href="/quickstart"><button class="button is-link is-normal is-hovered has-text-black" style="min-height: 4em; background-color: LimeGreen">➔ Schnellstart-Anleitung</button></a>
...
<a href="/help"><button class="button is-link is-normal is-hovered has-text-black" style="background-color: DeepSkyBlue">➔ Hilfe- und Support-Center</button></a>
