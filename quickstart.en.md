    ...
    <div class="box has-background-white-bis has-text-black" style="height: 100%; border-top: 4px solid #3273dc;">
      <div class="cell" style="display: flex; align-items: flex-start; gap: 0.5em;">
        ...
        <div>
          ...
          <p><small><em>'-GraphOnly true' ensures on-prem AD is ignored. Add the <a href="/parameters#cloudenvironment">'-CloudEnvironment'</a> parameter if using a national or sovereign cloud.</em></small>
          </p>
        </div>
      </div>
    </div>
...
<ul>
  ...
  <li><b>'Test all default replacement variables'</b> gives you a on overview of the integrated placeholders and a glimpse of what is possible for images and banners, phone number and address formatting.</li>
</ul>
<div class="columns is-multiline">
  <div class="column is-full">
    <div class="box has-background-white-bis has-text-black" style="height: 100%; border-top: 4px solid #ffdd57;">
