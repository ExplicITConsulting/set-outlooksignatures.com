...
```
If you are not using the public M365 cloud but a national or a sovereign variant, just add the parameter '`-CloudEnvironment [AzureUSGovernment|AzureUSGovernmentDoD|AzureChina|AzureBleu|AzureDelos|AzureGovSG]`'.
