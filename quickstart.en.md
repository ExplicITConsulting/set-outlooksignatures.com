...
<p>
  <div class="buttons">
    ...
    <a href="/benefactorcircle" class="button is-link is-normal is-hovered has-text-black has-text-weight-bold" style="background-image: inear-gradient(to bottom right, darkgoldenrod, goldenrod, goldenrod, goldenrod, darkgoldenrod)">The Benefactor Circle add-on</a>
  </div>
</p>
