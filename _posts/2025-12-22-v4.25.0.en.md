...
_**Variable replacement in Word is now much faster, but you must test your DOCX templates first.**_ You must make sure that every character of a replacement variable in the template is formatted identically, or the replacement will fail. An example is given in the full changelog linked below.
