...
- **Akademische oder berufliche Titel**  
  Titel wie _Dr._, _Prof._, _MBA_ oder _PhD_ müssen vor oder nach dem Namen erscheinen, teilweise abhängig von regionalen oder rechtlichen Konventionen.
...
Der Versuch, solche Informationen in Felder wie _Notes_, _Title_ oder _Department_ zu pressen, führt schnell zu Mehrdeutigkeiten, Inkonsistenzen und Governance-Problemen.
