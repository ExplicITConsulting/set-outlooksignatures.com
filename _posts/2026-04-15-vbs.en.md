...
**VBScript has been [officially marked as deprecated](https://techcommunity.microsoft.com/blog/windows-itpro-blog/vbscript-deprecation-timelines-and-next-steps/4148301) by Microsoft.** It’s no longer a question of _if_ your legacy signature scripts will stop working, but _when_.
...
- **The "New Outlook" Barrier:** Microsoft’s "New Outlook" for Windows does not support local script execution the way the Classic version did. Only a managed framework can bridge the gap to modern mailbox-based deployment using roaming signatures.
