...
<details id="procurement-outsourcer" class="box p-0">
  ...
  <p>To ensure transparency, predictability, and a fair allocation of costs based on causation, a flat processing fee equal to one man-day will be charged per procurement transaction in these configurations, in accordance with our Terms and Conditions for Professional Support. This regulation represents a standardized treatment of the corresponding procurement scenarios and applies regardless of the actual effort involved in individual cases.</p>
  <p>Alternative procurement channels (such as direct purchasing) as well as collaboration with procurement service providers that do not trigger these effects remain unaffected by this regulation.</p>
</details>
