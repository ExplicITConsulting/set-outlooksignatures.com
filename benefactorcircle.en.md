...
<div class="columns is-multiline">
  ...
  <div class="column is-one-third-desktop is-half-tablet is-full-mobile">
    <div class="cell" style="display: flex; align-items: flex-start; gap: 0.5em;">
      🏝️
      <div style="hyphens: manual;">
        <b>Out-Of-Office Replies</b><br>Manage and distribute OOF messages consistently and centrally from one location.
      </div>
    </div>
  </div>
  <div class="column is-one-third-desktop is-half-tablet is-full-mobile">
...
<p><a href="#trial" class="button is-link is-normal has-text-black has-text-weight-bold" style="background-image: linear-gradient(160deg, darkgoldenrod, goldenrod, palegoldenrod, goldenrod, darkgoldenrod);">Get a trial license, request a quote</a></p>
...
<div class="columns is-multiline">
  <div class="column is-half-desktop is-half-tablet is-full-mobile">
    ...
    <p><a href="/getlicense" class="button is-link is-normal has-text-black has-text-weight-bold" style="background-image: linear-gradient(160deg, darkgoldenrod, goldenrod, palegoldenrod, goldenrod, darkgoldenrod);">Get a 14-day trial license</a></p>
  </div>
  <div class="column is-half-desktop is-half-tablet is-full-mobile">
    ...
    <p><a href="/getlicense" class="button is-link is-normal has-text-black has-text-weight-bold" style="background-image: linear-gradient(160deg, darkgoldenrod, goldenrod, palegoldenrod, goldenrod, darkgoldenrod);">Request a license quote</a></p>
  </div>
</div>
...
<p>The <span style="font-weight: bold; color: var(--benefactor-circle-color);">Benefactor Circle add-on</span> unlocks advanced features — for <strong>just EUR 0.26 per mailbox/month</strong> (EUR 3.12 per year). Billed annually, no auto-renewal.</p>
...
<details id="procurement-outsourcer" class="box p-0">
  <summary class="has-text-weight-bold" style="cursor: pointer;">
    <strong>Click for details about handling via external procurement service providers (procurement outsourcers)</strong>
  </summary>
  ...
  <p>Since these effects have occurred consistently over the years — independent of project content or complexity — while producing completely identical professional results and delivered artifacts across all phases, they are classified as purely structural and process-related.</p>
  <p>To ensure transparency, predictability, and a fair allocation of costs based on causation, a flat processing fee equal to one man-day will be charged per procurement transaction in these configurations, in accordance with our <a href="https://explicitconsulting.at/support-terms">Professional Support Terms</a>. This regulation represents a standardized treatment of the corresponding procurement scenarios and applies regardless of the actual effort involved in individual cases.</p>
  <p>Alternative procurement channels (such as direct purchasing) as well as collaboration with procurement service providers that did not cause these effects in the past remain unaffected by this regulation.</p>
</details>
