        ...
        <div class="box has-background-white-bis has-text-black" style="border-top: 4px solid #48c774;">
            <div style="display: flex; align-items: flex-start; gap: 0.75em;">
                ...
                <div>
                    ...
                    <p class="mb-2"><b>Zero-Touch Deployment:</b> <a href="/details#creating-signatures-and-out-of-office-replies">SimulateAndDeploy</a><a href="#remark-1" style="color: var(--benefactor-circle-color);"><sup>(1)</sup></a> enables full automation without touching the end-user's device.</p>
