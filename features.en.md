...
* **Targeting:** Applied to all **mailboxes (including [shared mailboxes](/benefactorcircle#key-features)<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a>)**, specific **[mailbox groups](/details#template-tags-and-ini-files)**, specific **[email addresses](/details#template-tags-and-ini-files)** (including alias and secondary addresses), or specific **[user and mailbox properties](/details#template-tags-and-ini-files)**.
* **Outlook Support:** Works for **every mailbox across all Outlook profiles (Outlook, [New Outlook](/benefactorcircle#key-features)<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a>, [Outlook on the web](/benefactorcircle#key-features)<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a>)**, including **[automapped and additional mailboxes](/parameters#signaturesforautomappedandadditionalmailboxes)**<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a>.
...
* **Scheduling:** Assigned **[time ranges](/details#allowed-tags)**<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a> within which they are valid.
* **Defaults:** Set as **[default signature](/details#allowed-tags)** for new emails, replies, and forwards, or as **[default OOF message](/details#allowed-tags)**<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a> for internal/external recipients.

### 💻 Platform & Execution
* **Cloud Mirroring:** Set in **[Outlook on the web](/parameters#setcurrentuseroutlookwebsignature)**<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a> for the currently logged-in user, including mirroring signatures to the cloud as **[roaming signatures](/parameters#mirrorcloudsignatures)**<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a> (Linux/macOS/Windows, Classic and New Outlook<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a>).
* **User Control:** Signatures can be centrally managed only<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a>, or **[exist along user-created signatures](/parameters#deleteusercreatedsignatures)**.
* **Add-in Integration:** Automatically added to new emails, reply emails and appointments with the **[Outlook add-in](/outlookaddin)**<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a>.
* **Mobile & Third-Party:** Copied to an **[additional path](/parameters#additionalsignaturepath)**<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a> for easy access on mobile devices or use with Apple Mail, Google Gmail, Samsung Mail, Mozilla Thunderbird, GNOME Evolution, KDE KMail, and others.
* **Drafts API Fallback:** Create an **[email draft containing all available signatures](/parameters#signaturecollectionindrafts)**<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a> in HTML and plain text for mail clients without a signatures API.
* **Security:** **[Write protected](/details#allowed-tags)** (Outlook on Windows signatures only).

### 🛡️ Architecture & Infrastructure
* **Execution Flexibility:** **[Run by users on Windows, Linux and macOS clients (including shared devices/terminal servers) — or on a central system with a service account](/details#architecture-considerations)**<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a>.
...
* **Zero-Touch:** **[SimulateAndDeploy](/details#creating-signatures-and-out-of-office-replies)**<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a> allows deployment **[without any client deployment or end user interaction](/details#creating-signatures-and-out-of-office-replies)** (roaming signatures for Exchange Online).
...
* **Open Source:** **[Free and Open-Source (FOSS)](/faq#why-the-tagline)** under the European Union Public License (EUPL). After a certain period, a tagline is appended which can be easily removed<a href="#remark-1" style="color: var(--benefactor-circle-color);"><super>(1)</super></a>.
