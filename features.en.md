...
Set-OutlookSignatures is the most advanced, secure and versatile free and open-source tool for managing email signatures and out-of-office replies. With the optional Benefactor Circle add-on, it unlocks even more powerful features tailored for business environments.
    ...
    <table class="table is-bordered is-striped is-hoverable is-fullwidth">
        <thead>
            <tr>
                ...
                <th style="text-align:left">Set-OutlookSignatures<br>with the <span style="font-weight: bold; background-image: inear-gradient(to bottom right, darkgoldenrod, goldenrod, goldenrod, goldenrod, darkgoldenrod); background-clip: text; color: transparent;">Benefactor Circle add-on</span></th>
