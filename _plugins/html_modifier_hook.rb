...
module Jekyll
  module HtmlModifierHook
    ...
    # Note: This specific helper isn't directly used in HtmlModifierHook's main logic (it modifies output),
    # but it's crucial in the SearchDataCollector for content extraction. Keeping it here for consistency
    # if future needs arise or to easily share logic if refactored.
