...
- Flexibel zugewiesen werden: Für **alle Postfächer (auch shared mailboxes¹)**, **[Gruppen](/details#7-template-tags-and-ini-files)**, **[E-Mail-Adressen](/details#7-template-tags-and-ini-files)** (auch Alias und sekundäre Adressen), auf Basis von **[Benutzer- und Postfach-Attributen](/details#7-template-tags-and-ini-files)**, für **jedes Postfach in allen Profilen (Outlook, New Outlook¹, Outlook on the web¹)**, auch für **[automapped und zusätzliche Postfächer](/parameters#29-signaturesforautomappedandadditionalmailboxes)**¹. 
