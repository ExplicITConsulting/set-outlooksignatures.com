---
layout: page
title: '<div style="display: flex; align-items: center; justify-content: center;"><img src="/assets/images/set-outlooksignatures logo.png" alt="Set-Outlooksignatures" style="height: 2em; object-fit: contain;"> <img src="/assets/images/explicit consulting, color on transparent, company and slogan.png" alt="ExplicIT Consulting. We bridge the gap." style="height: 2em; object-fit: contain;"></div> <!--HTML 404-->'
subtitle: |
