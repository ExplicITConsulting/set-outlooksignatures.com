...
<p>
  <div class="buttons">
    <a href="/quickstart" class="button is-info is-normal is-hovered has-text-black  has-text-weight-bold">Schnellstart-Anleitung</a>
    <a href="/support#professional-support" class="button is-info is-normal is-hovered has-text-black  has-text-weight-bold">Support</a>
  </div>
</p>
