...
<script>
    (function() {
        ...
        // REDUNDANCY FIX: Liquid outputs the clean map directly into JS.
        // No DOM meta scraping, parsing, or string splitting required at runtime.
        const languages = {
        {% if site.languages %}
          {% for lang in site.languages %}
            {% assign lang_clean = lang | strip | downcase %}
        ...
        async function loadLanguageAssets(lang) {
            try {
                // Concurrently pull assets from cache hits generated by the preloader
