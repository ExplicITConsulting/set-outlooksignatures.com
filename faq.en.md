...
As all code of Set-OutlookSignatures, these functions not only work with the public cloud but also with national and sovereign clouds (GCC High, GCC DoD, China, Bleu, Delos, GovSG, and more).
...
With this documentation, Set-OutlookSignatures has since passed every security and governance audit. And these can be tough, as Set-OutlookSignatures not only works in public M365, but also in GCC High (US government), GCC DoD (US defence and military), and China national clouds, as well as with sovereign clouds (Bleu, Delos, GovSG, and more).
