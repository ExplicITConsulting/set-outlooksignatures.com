...
| Hints | Make sure to set the Outlook registry value '`Send Pictures With Document`' to 1, as described in the documentation of the '[EmbedImagesInHtml](/parameters#26-embedimagesinhtml)' parameter. | <p>Some older mail clients (Outlook 2013 and older, for example) cannot handle embedded images.</p><p>Images can look blurred and pixelated, especially on systems with high display resolution.</p> | Some older mail clients (Outlook 2013 and older, for example) cannot handle embedded images. | Images can look blurred and pixelated, especially on systems with high display resolution.<br><br>Make sure to set the Outlook registry value '`Send Pictures With Document`' to 1, as described in the documentation of the '[EmbedImagesInHtml](/parameters#26-embedimagesinhtml)' parameter. |
